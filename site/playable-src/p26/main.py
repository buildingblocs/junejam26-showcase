...
async def main():
    ...
    # load audios
    mixer.music.load("./assets/audio/bg.ogg")
    knock = mixer.Sound("./assets/audio/knock.ogg")
    mosquito_sound = mixer.Sound("./assets/audio/mosquito.ogg")
    impact_sound = mixer.Sound("./assets/audio/impact.ogg")
    impact_channel = pygame.mixer.Channel(2)
    explosion_sound = mixer.Sound('./assets/audio/explosion.ogg')
                    ...
                    while minigame_running:
                        ...
                        if keys[pygame.K_c]:
                            if RHand_state == "ready":
                                Hand_sound = mixer.Sound('./assets/audio/laser.ogg')
                                Hand_sound.play()
                                hand.x = paper.x
                                hand.y = paper.y
                                RHand(hand.x, hand.y)
